            ...
            <div class="row my-3">
                ...
                <div class="col-8">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="round" id="inlineRadio1" value="1" {{ \Carbon\Carbon::parse(now())->format('m') === 1 || 2 || 3 || 4 || 5 || 6 ? "checked" : "" }}>
                        <label class="form-check-label" for="inlineRadio1">กิจกรรมระหว่างเดือน (ม.ค. - มิ.ย.) รอบที 1</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="round" id="inlineRadio2" value="2" {{ \Carbon\Carbon::parse(now())->format('m') === 7 || 8 || 9 || 10 || 11 || 12 ? "checked" : "" }}>
                        <label class="form-check-label" for="inlineRadio2">กิจกรรมระหว่างเดือน (ก.ค. - ธ.ค.) รอบที 2</label>
                    </div>
                </div>
                <div class="col-1"></div>
            </div>
